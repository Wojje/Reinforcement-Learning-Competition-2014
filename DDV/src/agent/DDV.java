...
public class DDV implements AgentInterface {
	...
	private void updateObservedStateTrans(StateAction lastStateAction,
			State sprime) {
	...
	private Map<StateActionState, Double> computePTildes(StateAction sa,
			boolean upper) {
