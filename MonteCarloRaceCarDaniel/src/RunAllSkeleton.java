...
public class RunAllSkeleton{
	...
	public static void main(String[] args){
		...
		AgentLoader theAgentLoader=new AgentLoader(new MonteCarloAgent());
		//Create an environmentloader that will start the environment when its run method is called
		EnvironmentLoader theEnvironmentLoader=new EnvironmentLoader(new MonteCarloEnvironment());
		...
		MonteCarloExperiment.main(args);
